 ...
 * @author dragonyte
 */
public class ConfirmEventMoney extends javax.swing.JDialog {

    /**
     * Creates new form ConfirmEventMoney
     */
    public ConfirmEventMoney(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(300, 178));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmEventMoney.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfirmEventMoney dialog = new ConfirmEventMoney(new javax.swing.JFrame(), true);
